...
[![Portfolio](https://img.shields.io/badge/Portfolio-%23000000.svg?style=for-the-badge&logo=firefox&logoColor=#FF7139)](https://mamato.cloud)

## Projetos com IA
Possuo também alguns projetos simples construídos utilizando Lovable, n8n e outras ferramentas de automação. Convido à dar uma olhada caso tenha interesse:
- [Mecânica Clara - Cheque o que realmente precisa ser visto na revisão do seu carro](https://preview-mecanicaclara.lovable.app)
- [Idea Spark IA - Validador de ideias de produto](https://preview--ideia-spark-ia.lovable.app/)
- [UTM Buddy - Gerador de paràmetros UTM para campanhas de marketing](https://homolog-gerador-de-utms.lovable.app)
...
- AI Automation and Lovable Specialist
- Scrum SFPC
- Team Management
- Mobile Apps
